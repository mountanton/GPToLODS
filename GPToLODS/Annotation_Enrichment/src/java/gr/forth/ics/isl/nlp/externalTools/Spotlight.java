...
public class Spotlight {
    ...
    private static final String URLCand = "https://api.dbpedia-spotlight.org/en/candidates";
    ...
    private AnnotationUnit get() {
        ...
        try {
            annotationUnit = gson.fromJson(getContent(requestAnno), AnnotationUnit.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        ///spotlight.getEntityFromKeyWord("Nikos%20Kazantzakis%20was%20born%20in%20Heraklion");
...
//
    ...
    private ArrayList<String> getJsonContent(HttpGet request) throws IOException {
     ...
     public ArrayList<String> getEntityFromKeyWord(String keyword) {
        ...
        try {
            String serviceName = "keywordEntity";
            keywordEntity = new HttpGet("http://api.dbpedia-spotlight.org/en/candidates?text="+keyword);
